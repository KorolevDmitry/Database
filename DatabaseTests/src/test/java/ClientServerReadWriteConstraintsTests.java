...
public class ClientServerReadWriteConstraintsTests {
    ...
    @Test
    public void Write_1Server2Needed_Error() throws IOException, BalancerException, InterruptedException {
        //arrange
        Route routeServer1 = new Route("localhost:1107", ServerRole.MASTER, null);
        Route routeBalancer = new Route("localhost:1111", ServerRole.MASTER, null);
        ...
        TcpListener<StringSizable, StringSizable> server1 = CreateServer(routeServer1);
        TcpListener<StringSizable, StringSizable> balancer = CreateBalancer(routeBalancer);
        ClientEvaluator<StringSizable, StringSizable> client1 = CreateClient(routeBalancer, 1, 2);
    ...
    @Test
    public void Write_2Server2Needed_Success() throws IOException, BalancerException, InterruptedException {
        //arrange
        Route routeServer1 = new Route("localhost:1107", ServerRole.MASTER, null);
        Route routeServer2 = new Route("localhost:1108", ServerRole.SLAVE, routeServer1);
        Route routeBalancer = new Route("localhost:1111", ServerRole.MASTER, null);
        ...
        TcpListener<StringSizable, StringSizable> server2 = CreateServer(routeServer2);
        TcpListener<StringSizable, StringSizable> balancer = CreateBalancer(routeBalancer);
        ClientEvaluator<StringSizable, StringSizable> client1 = CreateClient(routeBalancer, 2, 2);
    ...
    @Test
    public void Write_2Server1Stopped2Needed_Error() throws IOException, BalancerException, InterruptedException {
        //arrange
        Route routeServer1 = new Route("localhost:1107", ServerRole.MASTER, null);
        Route routeServer2 = new Route("localhost:1108", ServerRole.SLAVE, routeServer1);
        Route routeBalancer = new Route("localhost:1111", ServerRole.MASTER, null);
